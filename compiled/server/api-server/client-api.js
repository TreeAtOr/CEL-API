...
var clientAPI = express_1.default();
/** Add Сдшуте
...
*/
clientAPI.post('/addClient', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                if (!(req.client.name === "Admin")) return [3 /*break*/, 2];
                _b = (_a = res).send;
                _d = (_c = JSON).stringify;
                return [4 /*yield*/, client_1.addClient(req.body.name, req.body.password)];
            case 1:
                _b.apply(_a, [_d.apply(_c, [(_e.sent()).token])]);
                return [3 /*break*/, 3];
            case 2:
